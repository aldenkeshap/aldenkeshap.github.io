...
const teamPrefixURL = 'https://site.api.espn.com/apis/site/v2/sports/basketball/womens-college-basketball/teams/';
const rankingsURL = 'https://site.api.espn.com/apis/site/v2/sports/basketball/womens-college-basketball/rankings';
const liveScorePrefixURL = 'https://www.espn.com/womens-college-basketball/game?gameId=';
...
function setGames(json) {
    ...
    for (game of json["events"]) {
        ...
        if (startDate < date && date < endDate) {
            ...
            const url = 'https://www.espn.com/womens-college-basketball/game?gameId=' + game["competitions"][0]["id"];
